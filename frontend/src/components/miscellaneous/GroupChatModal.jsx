...
import { useDisclosure,Button,Modal,ModalBody,ModalContent,ModalOverlay,ModalCloseButton,ModalHeader,ModalFooter,useToast, FormControl ,Input} from '@chakra-ui/react'
        ...
        <>
          ...
          <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <ModalContent>
              ...
              {selectedUsers.map(u=>(
                <UserBadgeItem key={user._id} user={u} handleFunction={()=>handleDelete(u)}></UserBadgeItem>
              ))}
