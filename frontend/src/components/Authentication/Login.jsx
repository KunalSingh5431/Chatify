...
const Login = () => {
  ...
  return (
    ...
    <Button colorScheme='green' width="75%" style={{marginTop:15}} onClick={submitHandler} fontWeight={"700"} isLoading={loading}> Login </Button>
    <Button variant="solid" colorScheme='red' width="75%" onClick={()=>{ setEmail("guest@example.com"); setPassword("123456");}} fontWeight={"700"}> Get Guest User Credentials </Button>
   </VStack>
  )
}
